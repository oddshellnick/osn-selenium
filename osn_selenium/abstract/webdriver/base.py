...
from typing import Any, AsyncGenerator, Literal, Mapping, Optional, Sequence, Tuple, Union
...
from osn_selenium.types import DEVICES_TYPEHINT, Position, Rectangle, Size, WindowRect
...
from osn_selenium.abstract.instances.action_chains import AbstractActionChains, AbstractHumanLikeActionChains
...
class AbstractWebDriver(ABC):
    ...
    @timeouts.setter
    @abstractmethod
    def timeouts(self, timeouts: Any) -> None:
        """
        Sets the timeouts for the current session.

        Args:
            timeouts (Any): An object representing the new timeout settings.
        """
        ...
    ...
    def orientation(self) -> Literal["LANDSCAPE", "PORTRAIT"]:
        ...
        Returns:
            str: The current orientation ('LANDSCAPE' or 'PORTRAIT').
        """
        ...

    @orientation.setter
    @abstractmethod
    def orientation(self, value: Literal["LANDSCAPE", "PORTRAIT"]) -> None:
        """
        Sets the orientation of the browser.

        Args:
            value (str): The new orientation ('LANDSCAPE' or 'PORTRAIT').
        """
        ...
    ...
    def file_detector(self, detector: Any) -> None:
        ...
        Args:
            detector (Any): The file detector instance to set.
        """
        ...
    ...
    def set_window_size(
        ...
        Args:
            ...
            window_handle (str): The handle of the window to resize. Defaults to "current".
        """
        ...
    ...
    def set_window_position(
        ...
        Args:
            ...
            window_handle (str): The handle of the window to move. Defaults to "current".
    ...
    def remove_credential(
        self,
        credential_id: Union[str, bytearray],
    ) -> None:
        """
    ...
    def print_page(
        self,
        print_options: Optional[Any] = None,
    ) -> str:
        """
    ...
    @abstractmethod
    async def _ensure_driver(self) -> Optional[legacyWebDriver]:
        """
