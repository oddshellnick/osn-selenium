...
from osn_selenium.flags.utils.base import _argument_to_flag, ArgumentValue, AttributeValue, BrowserArguments, BrowserAttributes, BrowserExperimentalOptions, BrowserFlags, ExperimentalOptionValue, FlagTypeNotDefined
...
class BrowserFlagsManager:
    ...
    def update_experimental_options(
            self,
            experimental_options: BrowserExperimentalOptions
    ):
        """
