...
class NetworkCDPExecutor(UnifiedNetworkCDPExecutor, TrioThreadMixin, AbstractNetworkCDPExecutor):
	...
	async def can_clear_browser_cache(self) -> bool:
		return await self._sync_to_trio(self._can_clear_browser_cache_impl)
	
	async def can_clear_browser_cookies(self) -> bool:
		return await self._sync_to_trio(self._can_clear_browser_cookies_impl)
	
	async def can_emulate_network_conditions(self) -> bool:
		return await self._sync_to_trio(self._can_emulate_network_conditions_impl)
	
	async def clear_accepted_encodings_override(self) -> None:
		return await self._sync_to_trio(self._clear_accepted_encodings_override_impl)
	
	async def clear_browser_cache(self) -> None:
		return await self._sync_to_trio(self._clear_browser_cache_impl)
	
	async def clear_browser_cookies(self) -> None:
		return await self._sync_to_trio(self._clear_browser_cookies_impl)
	...
	async def continue_intercepted_request(
		...
		return await self._sync_to_trio(
				self._continue_intercepted_request_impl,
	...
	async def emulate_network_conditions(
		...
		return await self._sync_to_trio(
				self._emulate_network_conditions_impl,
				offline=offline,
				latency=latency,
	...
	async def emulate_network_conditions_by_rule(self, offline: bool, matched_network_conditions: List[Dict[str, Any]]) -> List[str]:
		return await self._sync_to_trio(
				self._emulate_network_conditions_by_rule_impl,
				offline=offline,
	...
	async def enable_reporting_api(self, enable: bool) -> None:
		return await self._sync_to_trio(self._enable_reporting_api_impl, enable=enable)
	
	async def get_all_cookies(self) -> List[Dict[str, Any]]:
		return await self._sync_to_trio(self._get_all_cookies_impl)
	
	async def get_certificate(self, origin: str) -> List[str]:
		return await self._sync_to_trio(self._get_certificate_impl, origin=origin)
	
	async def get_cookies(self, urls: Optional[List[str]] = None) -> List[Dict[str, Any]]:
		return await self._sync_to_trio(self._get_cookies_impl, urls=urls)
	
	async def get_ip_protection_proxy_status(self) -> str:
		return await self._sync_to_trio(self._get_ip_protection_proxy_status_impl)
	
	async def get_request_post_data(self, request_id: str) -> str:
		return await self._sync_to_trio(self._get_request_post_data_impl, request_id=request_id)
	...
	async def get_response_body_for_interception(self, interception_id: str) -> Tuple[str, bool]:
		return await self._sync_to_trio(
				self._get_response_body_for_interception_impl,
				interception_id=interception_id
		)
	
	async def get_security_isolation_status(self, frame_id: Optional[str] = None) -> Dict[str, Any]:
		return await self._sync_to_trio(self._get_security_isolation_status_impl, frame_id=frame_id)
	...
	async def load_network_resource(
		...
		return await self._sync_to_trio(
				self._load_network_resource_impl,
				frame_id=frame_id,
				url=url,
				options=options
		)
	...
	async def override_network_state(
		...
		return await self._sync_to_trio(
				self._override_network_state_impl,
				offline=offline,
				latency=latency,
				download_throughput=download_throughput,
				upload_throughput=upload_throughput,
	...
	async def replay_xhr(self, request_id: str) -> None:
		return await self._sync_to_trio(self._replay_xhr_impl, request_id=request_id)
	...
	async def search_in_response_body(
		...
		return await self._sync_to_trio(
				self._search_in_response_body_impl,
	...
	async def set_accepted_encodings(self, encodings: List[str]) -> None:
		return await self._sync_to_trio(self._set_accepted_encodings_impl, encodings=encodings)
	
	async def set_attach_debug_stack(self, enabled: bool) -> None:
		return await self._sync_to_trio(self._set_attach_debug_stack_impl, enabled=enabled)
	...
	async def set_blocked_ur_ls(
		...
		return await self._sync_to_trio(self._set_blocked_ur_ls_impl, url_patterns=url_patterns, urls=urls)
	
	async def set_bypass_service_worker(self, bypass: bool) -> None:
		return await self._sync_to_trio(self._set_bypass_service_worker_impl, bypass=bypass)
	
	async def set_cache_disabled(self, cache_disabled: bool) -> None:
		return await self._sync_to_trio(self._set_cache_disabled_impl, cache_disabled=cache_disabled)
	...
	async def set_cookie_controls(
		...
		return await self._sync_to_trio(
				self._set_cookie_controls_impl,
	...
	async def set_cookies(self, cookies: List[Dict[str, Any]]) -> None:
		return await self._sync_to_trio(self._set_cookies_impl, cookies=cookies)
	
	async def set_extra_http_headers(self, headers: Dict[Any, Any]) -> None:
		return await self._sync_to_trio(self._set_extra_http_headers_impl, headers=headers)
	
	async def set_ip_protection_proxy_bypass_enabled(self, enabled: bool) -> None:
		return await self._sync_to_trio(self._set_ip_protection_proxy_bypass_enabled_impl, enabled=enabled)
	
	async def set_request_interception(self, patterns: List[Dict[str, Any]]) -> None:
		return await self._sync_to_trio(self._set_request_interception_impl, patterns=patterns)
	...
	async def stream_resource_content(self, request_id: str) -> str:
		return await self._sync_to_trio(self._stream_resource_content_impl, request_id=request_id)
	
	async def take_response_body_for_interception_as_stream(self, interception_id: str) -> str:
		return await self._sync_to_trio(
				self._take_response_body_for_interception_as_stream_impl,
				interception_id=interception_id
		)
