...
class EmulationCDPExecutor(
	...
	async def can_emulate(self) -> bool:
		return await self._sync_to_trio(self._can_emulate_impl)
	...
	async def clear_device_posture_override(self) -> None:
		return await self._sync_to_trio(self._clear_device_posture_override_impl)
	
	async def clear_display_features_override(self) -> None:
		return await self._sync_to_trio(self._clear_display_features_override_impl)
	...
	async def clear_idle_override(self) -> None:
		return await self._sync_to_trio(self._clear_idle_override_impl)
	
	async def get_overridden_sensor_information(self, type_: str) -> float:
		return await self._sync_to_trio(self._get_overridden_sensor_information_impl, type_=type_)
	
	async def get_screen_infos(self) -> List[Dict[str, Any]]:
		return await self._sync_to_trio(self._get_screen_infos_impl)
	
	async def remove_screen(self, screen_id: str) -> None:
		return await self._sync_to_trio(self._remove_screen_impl, screen_id=screen_id)
	
	async def reset_page_scale_factor(self) -> None:
		return await self._sync_to_trio(self._reset_page_scale_factor_impl)
	
	async def set_auto_dark_mode_override(self, enabled: Optional[bool] = None) -> None:
		return await self._sync_to_trio(self._set_auto_dark_mode_override_impl, enabled=enabled)
	
	async def set_automation_override(self, enabled: bool) -> None:
		return await self._sync_to_trio(self._set_automation_override_impl, enabled=enabled)
	
	async def set_cpu_throttling_rate(self, rate: float) -> None:
		return await self._sync_to_trio(self._set_cpu_throttling_rate_impl, rate=rate)
	
	async def set_data_saver_override(self, data_saver_enabled: Optional[bool] = None) -> None:
		return await self._sync_to_trio(
				self._set_data_saver_override_impl,
	...
	async def set_default_background_color_override(self, color: Optional[Dict[str, Any]] = None) -> None:
		return await self._sync_to_trio(self._set_default_background_color_override_impl, color=color)
	...
	async def set_device_posture_override(self, posture: Dict[str, Any]) -> None:
		return await self._sync_to_trio(self._set_device_posture_override_impl, posture=posture)
	
	async def set_disabled_image_types(self, image_types: List[str]) -> None:
		return await self._sync_to_trio(self._set_disabled_image_types_impl, image_types=image_types)
	
	async def set_display_features_override(self, features: List[Dict[str, Any]]) -> None:
		return await self._sync_to_trio(self._set_display_features_override_impl, features=features)
	
	async def set_document_cookie_disabled(self, disabled: bool) -> None:
		return await self._sync_to_trio(self._set_document_cookie_disabled_impl, disabled=disabled)
	
	async def set_emit_touch_events_for_mouse(self, enabled: bool, configuration: Optional[str] = None) -> None:
		return await self._sync_to_trio(
				self._set_emit_touch_events_for_mouse_impl,
				enabled=enabled,
	...
	async def set_emulated_media(
		...
		return await self._sync_to_trio(self._set_emulated_media_impl, media=media, features=features)
	
	async def set_emulated_os_text_scale(self, scale: Optional[float] = None) -> None:
		return await self._sync_to_trio(self._set_emulated_os_text_scale_impl, scale=scale)
	
	async def set_emulated_vision_deficiency(self, type_: str) -> None:
		return await self._sync_to_trio(self._set_emulated_vision_deficiency_impl, type_=type_)
	
	async def set_focus_emulation_enabled(self, enabled: bool) -> None:
		return await self._sync_to_trio(self._set_focus_emulation_enabled_impl, enabled=enabled)
	...
	async def set_locale_override(self, locale: Optional[str] = None) -> None:
		return await self._sync_to_trio(self._set_locale_override_impl, locale=locale)
	
	async def set_navigator_overrides(self, platform: str) -> None:
		return await self._sync_to_trio(self._set_navigator_overrides_impl, platform=platform)
	
	async def set_page_scale_factor(self, page_scale_factor: float) -> None:
		return await self._sync_to_trio(self._set_page_scale_factor_impl, page_scale_factor=page_scale_factor)
	...
	async def set_pressure_data_override(
		...
		return await self._sync_to_trio(
				self._set_pressure_data_override_impl,
				source=source,
				state=state,
	...
	async def set_pressure_source_override_enabled(
		...
		return await self._sync_to_trio(
				self._set_pressure_source_override_enabled_impl,
				enabled=enabled,
				source=source,
				metadata=metadata
		)
	...
	async def set_pressure_state_override(self, source: str, state: str) -> None:
		return await self._sync_to_trio(self._set_pressure_state_override_impl, source=source, state=state)
	
	async def set_safe_area_insets_override(self, insets: Dict[str, Any]) -> None:
		return await self._sync_to_trio(self._set_safe_area_insets_override_impl, insets=insets)
	
	async def set_script_execution_disabled(self, value: bool) -> None:
		return await self._sync_to_trio(self._set_script_execution_disabled_impl, value=value)
	
	async def set_scrollbars_hidden(self, hidden: bool) -> None:
		return await self._sync_to_trio(self._set_scrollbars_hidden_impl, hidden=hidden)
	
	async def set_sensor_override_enabled(self, enabled: bool, type_: str, metadata: Optional[Dict[str, Any]] = None) -> None:
		return await self._sync_to_trio(
				self._set_sensor_override_enabled_impl,
				enabled=enabled,
				type_=type_,
				metadata=metadata
		)
	...
	async def set_sensor_override_readings(self, type_: str, reading: Dict[str, Any]) -> None:
		return await self._sync_to_trio(self._set_sensor_override_readings_impl, type_=type_, reading=reading)
	
	async def set_small_viewport_height_difference_override(self, difference: int) -> None:
		return await self._sync_to_trio(
				self._set_small_viewport_height_difference_override_impl,
				difference=difference
		)
	
	async def set_timezone_override(self, timezone_id: str) -> None:
		return await self._sync_to_trio(self._set_timezone_override_impl, timezone_id=timezone_id)
	...
	async def set_user_agent_override(
		...
		return await self._sync_to_trio(
				self._set_user_agent_override_impl,
	...
	async def set_virtual_time_policy(
		...
		return await self._sync_to_trio(
				self._set_virtual_time_policy_impl,
				policy=policy,
				budget=budget,
	...
	async def set_visible_size(self, width: int, height: int) -> None:
		return await self._sync_to_trio(self._set_visible_size_impl, width=width, height=height)
