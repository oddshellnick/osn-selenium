...
class PageCDPExecutor(UnifiedPageCDPExecutor, TrioThreadMixin, AbstractPageCDPExecutor):
	...
	async def add_compilation_cache(self, url: str, data: str) -> None:
		return await self._sync_to_trio(self._add_compilation_cache_impl, url=url, data=data)
	
	async def add_script_to_evaluate_on_load(self, script_source: str) -> str:
		return await self._sync_to_trio(self._add_script_to_evaluate_on_load_impl, script_source=script_source)
	...
	async def add_script_to_evaluate_on_new_document(
		...
		return await self._sync_to_trio(
				self._add_script_to_evaluate_on_new_document_impl,
				source=source,
	...
	async def bring_to_front(self) -> None:
		return await self._sync_to_trio(self._bring_to_front_impl)
	...
	async def capture_snapshot(self, format_: Optional[str] = None) -> str:
		return await self._sync_to_trio(self._capture_snapshot_impl, format_=format_)
	
	async def clear_compilation_cache(self) -> None:
		return await self._sync_to_trio(self._clear_compilation_cache_impl)
	
	async def clear_device_metrics_override(self) -> None:
		return await self._sync_to_trio(self._clear_device_metrics_override_impl)
	...
	async def clear_geolocation_override(self) -> None:
		return await self._sync_to_trio(self._clear_geolocation_override_impl)
	...
	async def create_isolated_world(
		...
		return await self._sync_to_trio(
				self._create_isolated_world_impl,
				frame_id=frame_id,
				world_name=world_name,
	...
	async def delete_cookie(self, cookie_name: str, url: str) -> None:
		return await self._sync_to_trio(self._delete_cookie_impl, cookie_name=cookie_name, url=url)
	...
	async def generate_test_report(self, message: str, group: Optional[str] = None) -> None:
		return await self._sync_to_trio(self._generate_test_report_impl, message=message, group=group)
	
	async def get_ad_script_ancestry(self, frame_id: str) -> Optional[Dict[str, Any]]:
		return await self._sync_to_trio(self._get_ad_script_ancestry_impl, frame_id=frame_id)
	
	async def get_app_id(self) -> Tuple[Optional[str], Optional[str]]:
		return await self._sync_to_trio(self._get_app_id_impl)
	...
	async def get_app_manifest(self, manifest_id: Optional[str] = None) -> Tuple[str, List[Dict[str, Any]], Optional[str], Optional[Dict[str, Any]], Dict[str, Any]]:
		return await self._sync_to_trio(self._get_app_manifest_impl, manifest_id=manifest_id)
	
	async def get_frame_tree(self) -> Dict[str, Any]:
		return await self._sync_to_trio(self._get_frame_tree_impl)
	
	async def get_installability_errors(self) -> List[Dict[str, Any]]:
		return await self._sync_to_trio(self._get_installability_errors_impl)
	...
	async def get_layout_metrics(self) -> Tuple[
		...
		return await self._sync_to_trio(self._get_layout_metrics_impl)
	
	async def get_manifest_icons(self) -> Optional[str]:
		return await self._sync_to_trio(self._get_manifest_icons_impl)
	
	async def get_navigation_history(self) -> Tuple[int, List[Dict[str, Any]]]:
		return await self._sync_to_trio(self._get_navigation_history_impl)
	
	async def get_origin_trials(self, frame_id: str) -> List[Dict[str, Any]]:
		return await self._sync_to_trio(self._get_origin_trials_impl, frame_id=frame_id)
	
	async def get_permissions_policy_state(self, frame_id: str) -> List[Dict[str, Any]]:
		return await self._sync_to_trio(self._get_permissions_policy_state_impl, frame_id=frame_id)
	
	async def get_resource_content(self, frame_id: str, url: str) -> Tuple[str, bool]:
		return await self._sync_to_trio(self._get_resource_content_impl, frame_id=frame_id, url=url)
	
	async def get_resource_tree(self) -> Dict[str, Any]:
		return await self._sync_to_trio(self._get_resource_tree_impl)
	
	async def handle_java_script_dialog(self, accept: bool, prompt_text: Optional[str] = None) -> None:
		return await self._sync_to_trio(
				self._handle_java_script_dialog_impl,
				accept=accept,
	...
	async def navigate_to_history_entry(self, entry_id: int) -> None:
		return await self._sync_to_trio(self._navigate_to_history_entry_impl, entry_id=entry_id)
	...
	async def produce_compilation_cache(self, scripts: List[Dict[str, Any]]) -> None:
		return await self._sync_to_trio(self._produce_compilation_cache_impl, scripts=scripts)
	...
	async def remove_script_to_evaluate_on_load(self, identifier: str) -> None:
		return await self._sync_to_trio(self._remove_script_to_evaluate_on_load_impl, identifier=identifier)
	
	async def remove_script_to_evaluate_on_new_document(self, identifier: str) -> None:
		return await self._sync_to_trio(
				self._remove_script_to_evaluate_on_new_document_impl,
				identifier=identifier
		)
	
	async def reset_navigation_history(self) -> None:
		return await self._sync_to_trio(self._reset_navigation_history_impl)
	
	async def screencast_frame_ack(self, session_id: int) -> None:
		return await self._sync_to_trio(self._screencast_frame_ack_impl, session_id=session_id)
	...
	async def set_ad_blocking_enabled(self, enabled: bool) -> None:
		return await self._sync_to_trio(self._set_ad_blocking_enabled_impl, enabled=enabled)
	
	async def set_bypass_csp(self, enabled: bool) -> None:
		return await self._sync_to_trio(self._set_bypass_csp_impl, enabled=enabled)
	...
	async def set_device_metrics_override(
		...
		return await self._sync_to_trio(
				self._set_device_metrics_override_impl,
				width=width,
				height=height,
	...
	async def set_document_content(self, frame_id: str, html: str) -> None:
		return await self._sync_to_trio(self._set_document_content_impl, frame_id=frame_id, html=html)
	...
	async def set_font_families(
		...
		return await self._sync_to_trio(
				self._set_font_families_impl,
				font_families=font_families,
				for_scripts=for_scripts
		)
	
	async def set_font_sizes(self, font_sizes: Dict[str, Any]) -> None:
		return await self._sync_to_trio(self._set_font_sizes_impl, font_sizes=font_sizes)
	...
	async def set_geolocation_override(
		...
		return await self._sync_to_trio(
				self._set_geolocation_override_impl,
				latitude=latitude,
				longitude=longitude,
				accuracy=accuracy
		)
	...
	async def set_intercept_file_chooser_dialog(self, enabled: bool, cancel: Optional[bool] = None) -> None:
		return await self._sync_to_trio(
				self._set_intercept_file_chooser_dialog_impl,
				enabled=enabled,
				cancel=cancel
		)
	
	async def set_lifecycle_events_enabled(self, enabled: bool) -> None:
		return await self._sync_to_trio(self._set_lifecycle_events_enabled_impl, enabled=enabled)
	
	async def set_prerendering_allowed(self, is_allowed: bool) -> None:
		return await self._sync_to_trio(self._set_prerendering_allowed_impl, is_allowed=is_allowed)
	
	async def set_rph_registration_mode(self, mode: str) -> None:
		return await self._sync_to_trio(self._set_rph_registration_mode_impl, mode=mode)
	
	async def set_spc_transaction_mode(self, mode: str) -> None:
		return await self._sync_to_trio(self._set_spc_transaction_mode_impl, mode=mode)
	
	async def set_touch_emulation_enabled(self, enabled: bool, configuration: Optional[str] = None) -> None:
		return await self._sync_to_trio(
				self._set_touch_emulation_enabled_impl,
				enabled=enabled,
				configuration=configuration
		)
	
	async def set_web_lifecycle_state(self, state: str) -> None:
		return await self._sync_to_trio(self._set_web_lifecycle_state_impl, state=state)
	...
	async def stop_loading(self) -> None:
		return await self._sync_to_trio(self._stop_loading_impl)
	
	async def stop_screencast(self) -> None:
		return await self._sync_to_trio(self._stop_screencast_impl)
	
	async def wait_for_debugger(self) -> None:
		return await self._sync_to_trio(self._wait_for_debugger_impl)
