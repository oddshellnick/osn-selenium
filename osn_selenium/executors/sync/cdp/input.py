...
class InputCDPExecutor(AbstractInputCDPExecutor):
	...
	def cancel_dragging(self) -> None:
		return self._execute_function("Input.cancelDragging", locals())
	...
	def dispatch_drag_event(
		...
		return self._execute_function("Input.dispatchDragEvent", locals())
	...
	def dispatch_key_event(
		...
		return self._execute_function("Input.dispatchKeyEvent", locals())
	...
	def dispatch_mouse_event(
		...
		return self._execute_function("Input.dispatchMouseEvent", locals())
	...
	def dispatch_touch_event(
		...
		return self._execute_function("Input.dispatchTouchEvent", locals())
	...
	def emulate_touch_from_mouse_event(
		...
		return self._execute_function("Input.emulateTouchFromMouseEvent", locals())
	...
	def ime_set_composition(
		...
		return self._execute_function("Input.imeSetComposition", locals())
	
	def insert_text(self, text: str) -> None:
		return self._execute_function("Input.insertText", locals())
	
	def set_ignore_input_events(self, ignore: bool) -> None:
		return self._execute_function("Input.setIgnoreInputEvents", locals())
	
	def set_intercept_drags(self, enabled: bool) -> None:
		return self._execute_function("Input.setInterceptDrags", locals())
	...
	def synthesize_pinch_gesture(
		...
		return self._execute_function("Input.synthesizePinchGesture", locals())
	...
	def synthesize_scroll_gesture(
		...
		return self._execute_function("Input.synthesizeScrollGesture", locals())
	...
	def synthesize_tap_gesture(
		...
		return self._execute_function("Input.synthesizeTapGesture", locals())
