...
from osn_selenium.abstract.executors.cdp import AbstractTargetCDPExecutor
...
class TargetCDPExecutor(AbstractTargetCDPExecutor):
    ...
    def attach_to_browser_target(self) -> str:
        return self._execute_function("Target.attachToBrowserTarget", locals())
    ...
    def get_browser_contexts(self) -> List[str]:
        return self._execute_function("Target.getBrowserContexts", locals())
