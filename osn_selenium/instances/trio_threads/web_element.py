...
class WebElement(_TrioThreadMixin, AbstractWebElement):
	...
	def from_legacy(
		...
		return cls(selenium_web_element=selenium_web_element, lock=lock, limiter=limiter)
	
	async def find_element(self, by: str = By.ID, value: Any = None,) -> "WebElement":
	...
	async def find_elements(self, by: str = By.ID, value: Any = None,) -> List["WebElement"]:
