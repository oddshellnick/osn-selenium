...
class LifecycleMixin(TargetsMixin):
    ...
    async def run(self) -> None:
        ...
        self._bidi_connection: AbstractAsyncContextManager[
            BidiConnection,
            Any
        ] = self._webdriver.driver.bidi_connection()
        ...
        self._main_logger_send_channel, self._main_logger = build_main_logger(
            self._nursery_object,
